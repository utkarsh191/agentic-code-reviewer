      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="mt-6 border border-gray-800 bg-gray-900 rounded-xl p-6">
          ...
          <div className="mt-4 space-y-3">
            <div className="w-full text-left border border-blue-500 bg-blue-950/20 rounded-lg p-4">
            ...
            <div className="w-full text-left border border-gray-800 rounded-lg p-4">
              <p className="font-medium">
                src/user.js
              </p>
